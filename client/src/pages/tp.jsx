        ...
        <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
            ...
            <div className='flex flex-wrap gap-6'>
                <div className="flex item-center gap-2">
                    <input className='p-3 border-grey-300 rounded-lg' type="number" id="bedrooms" min="1" max="10" required onChange={handleChange} checked={formData.bedrooms}/>
                    <p>Beds</p>
                </div>
                <div className="flex item-center gap-2">
                    <input className='p-3 border-grey-300 rounded-lg' type="number" id="bathrooms" min="1" max="10" required onChange={handleChange} checked={formData.bathrooms}/>
                    <p>Baths</p>
                </div>
                <div className="flex item-center gap-2">
                    <input className='p-3 border-grey-300 rounded-lg' type="number" id="regularPrice" min="50" max="1000000000" required onChange={handleChange} checked={formData.regularPrice}/>
                    ...
                    {formData.offer && (
                <div className="flex item-center gap-2">
                        <input className='p-3 border-grey-300 rounded-lg' type="number" id="discountPrice" min="0" required onChange={handleChange} checked={formData.discountPrice}/>
                    <div className='flex flex-col item-center'>
                    <p>Discount Price</p>
                    <span className='text-xs'>₹ /month</span>
                    </div>
            ...
            <div className='flex flex-col gap-4 flex-1'>
                <p className= "font-semibold">
                    Images:
                    <span className='font-normal text-grey-600 ml-2'>The first will be the cover (max 6)</span>
                </p>
                <div className='flex gap-4'>
                    <input onChange={(e) => setFiles(e.target.files)} className='p-3 border-grey-300 rounded w-full' type="file" id='images' accept='image/*' multiple />
